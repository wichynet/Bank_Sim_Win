...
namespace Bank_Sim_Win {
    ...
    public partial class BankDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow AddCustomerRow(string IBAN, string FullName, decimal Amount) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow FindByIBAN(string IBAN) {
        ...
        public partial class CustomerRow : global::System.Data.DataRow {
            ...
            public string IBAN {
                get {
                    return ((string)(this[this.tableCustomer.IBANColumn]));
                }
                set {
                    this[this.tableCustomer.IBANColumn] = value;
                }
            }
            ...
            public decimal Amount {
                get {
                    return ((decimal)(this[this.tableCustomer.AmountColumn]));
                }
                set {
...
namespace Bank_Sim_Win.BankDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customer] WHERE (([IBAN] = @Original_IBAN) AND ([FullName] = @" +
                "Original_FullName) AND ([Amount] = @Original_Amount))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([IBAN], [FullName], [Amount]) VALUES (@IBAN, @FullN" +
                "ame, @Amount);\r\nSELECT IBAN, FullName, Amount FROM Customer WHERE (IBAN = @IBAN)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [IBAN] = @IBAN, [FullName] = @FullName, [Amount] = @Amount WHERE (([IBAN] = @Original_IBAN) AND ([FullName] = @Original_FullName) AND ([Amount] = @Original_Amount));
SELECT IBAN, FullName, Amount FROM Customer WHERE (IBAN = @IBAN)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Bank_Sim_Win.Properties.Settings.Default.BankConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IBAN, FullName, Amount FROM dbo.Customer";
        ...
        public virtual int Delete(string Original_IBAN, string Original_FullName, decimal Original_Amount) {
        ...
        public virtual int Insert(string IBAN, string FullName, decimal Amount) {
            if ((IBAN == null)) {
        ...
        public virtual int Update(string IBAN, string FullName, decimal Amount, string Original_IBAN, string Original_FullName, decimal Original_Amount) {
            if ((IBAN == null)) {
                throw new global::System.ArgumentNullException("IBAN");
            }
            else {
            ...
            if ((Original_IBAN == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_IBAN));
            }
            if ((Original_FullName == null)) {
                throw new global::System.ArgumentNullException("Original_FullName");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, decimal Amount, string Original_IBAN, string Original_FullName, decimal Original_Amount) {
            return this.Update(Original_IBAN, FullName, Amount, Original_IBAN, Original_FullName, Original_Amount);
        }
    }
